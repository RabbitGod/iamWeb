...
<template> 
    <div class="maintain_cont" >
        ...
        <Modal v-model="voidedModal" width="460">
            <p slot="header" style="color:#f60;text-align:left">
                <Icon type="ios-information-circle"></Icon>
                <span>确定要作废这条账号信息变动申请吗</span>
            </p>
            <div style="text-align:left">
                <p>作废后新增账号将取消新增，更新账号将恢复到原来修改前状态</p>
            </div>
            <div slot="footer">
                <Button type="error"   @click="voidedModal = false">作废</Button>
                <Button  @click="voidedModal = false">取消</Button>
            </div>
        </Modal>
    </div>
</template>
                        ...
                        render: (h, params) => {
                            return h('div', [
                                ...
                                h('Button', {
                                    ...
                                    style: {
                                        marginRight: '5px',
                                        display:params.row.status == '被驳回'?'none':'inline-block'
                                    },
                                    on: {
                                        click: () => {
                                ...
                                h('Button', {
                                    ...
                                    style: {
                                        marginRight: '5px',
                                        display:params.row.status == '被驳回'?'inline-block':'none'
                                    },
                                    on: {
                                        click: () => {
